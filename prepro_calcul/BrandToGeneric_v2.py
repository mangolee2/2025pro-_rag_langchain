...
# 1. CSV 파일 불러오기
df = pd.read_csv('/data1/workspace/prepro_calcul/t3.csv')
...
# =========================================================================
# # 1. 입력 CSV 파일 이름
# INPUT_FILE_NAME = 'pred_4.csv' 
# # 2. 약물 이름이 들어있는 컬럼 이름
# DRUG_NAME_COLUMN = 'single_drug' 
# # 3. 출력할 새로운 CSV 파일 이름
# OUTPUT_FILE_NAME = 'pred_4_generic.csv'
# # =========================================================================
...
# =========================================================================
# 1. 입력 CSV 파일 이름
INPUT_FILE_NAME = '/data1/workspace/prepro_calcul/t3.csv' 
# 2. 약물 이름이 들어있는 컬럼 이름
DRUG_LIST_COLUMN = 'drug' 
# 3. 약물 리스트를 구분하는 기호 (여기서는 세미콜론)
DELIMITER = ';'
# 4. 출력할 새로운 CSV 파일 이름
OUTPUT_FILE_NAME = '/data1/workspace/prepro_calcul/t3.csv'
# =========================================================================
